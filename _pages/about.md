...
<div style="display: flex; gap: 20px;">
  ...
  <!-- New Section (for example, Publications) -->
  <div style="flex: 1;">
    ## Publication Highlights
    - 2024: [A comprehensive survey on FPGA security](#)
    - 2023: [Defending against side-channel attacks on heterogeneous computing platforms](#)
    - 2022: [A new method for secure cloud computing](#)
    <!-- Add more publications or content as needed -->
  </div>
</div>